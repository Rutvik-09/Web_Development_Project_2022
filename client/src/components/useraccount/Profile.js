...
const Profile = () => {
  ...
  const onSubmit = (formValues) => {
    ...
    console.log("fristname"+formValues.firstName);
    ...
    axios.post(constant.BE_URL + "userdetails/updateProfileDetails", dataToBeUpdate)
      .then(
        response => {
  ...
  return (
    ...
    <Formik
      ...
      onSubmit={onSubmit}
      component={(props) => <ProfileForm {...props} setProfilePic={setProfilePic} profilePic={profilePic} ></ProfileForm>} />
  );
