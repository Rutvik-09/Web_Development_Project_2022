      ...
      <MDBContainer>
        ...
        <MDBRow>
          ...
          <MDBCol lg="6" md="8">
            ...
            <div className="input">
              <MDBInput type="input" outline size="lg" value={reviewTitle} onChange={(e) => setReviewTitle(e.target.value)}/>
            </div>
            ...
            <div className="input">
              <MDBInput type="textarea" outline value={reviewDescription} onChange={(e) => setReviewDescription(e.target.value)} />
            </div>
